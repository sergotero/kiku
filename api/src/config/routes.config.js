...
router.post(`/api/reports`,checkUser, ReportController.create);
router.get(`/api/reports`,checkAdmin, ReportController.list); //Only admin
router.get(`/api/reports/:id`,checkAdmin, ReportController.detail); //Only admin
router.patch(`/api/reports/:id`,checkAdmin, ReportController.update); //Only admin
router.delete(`/api/reports/:id`,checkAdmin, ReportController.destroy); //Only admin
