  ...
  return (
    <MainLayout>
      <section className={styles.intro}>
        <h2>Idioma, Pensamiento y Cerebro</h2>
        <p>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <span className="jp-line"><ruby>暑<rt>あつ</rt>い</ruby></span><br />Atsui
              </td>
              <td>
                <span className="jp-line"><ruby>熱<rt>あつ</rt>い</ruby></span><br />Atsui
              </td>
              <td>
                Caliente
              </td>
              <td>
                Pese a que ambas palabras se lean igual, en japonés queda claro que una es usada en referencia a objetos (<span className="jp-line">暑い</span>), mientras que la otra en relación al clima (<span className="jp-line">熱い</span>). Sin embargo, este matiz es evidente cuando usamos el alemán como comparación que sí distingue entre <em>warm</em> y <em>heiß</em>.
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <span className="jp-line"><ruby>一人<rt>ひとり</rt></ruby></span><br />Hitori
              </td>
              <td>
                <span className="jp-line"><ruby>寂<rt>さび</rt>しい</ruby></span><br />Sabishii
              </td>
              <td>
                Solo
              </td>
      ...
      <section className={styles.options}>
        ...
        <h2>¿Por qué Kiku?</h2>
        <p>
          Nuestro nombre nace de la rica polisemia del idioma japonés. Kiku captura tres pilares fundamentales de nuestra metodología:
        </p>
        <table>
          <thead>
            <th>Palabra</th>
